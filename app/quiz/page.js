...
function RegistrationForm({ onSubmit }) {
  ...
  const inputStyle = (key) => ({
    ...
    border: `2px solid ${
      errors[key] ? '#ef4444' : 'rgba(6,3,141,0.15)'
    }`,
    borderRadius: '12px',
    paddingLeft: '48px',
    paddingRight: '16px',
  ...
  return (
    ...
    >
      <div className="text-center mb-10">
        ...
        <h1
          className="section-title text-3xl sm:text-4xl mb-3"
          style={{ color: '#0A0840' }}
        >
          {q.regTitle1}{' '}
          <span
        ...
        <p style={{ color: '#5B5A9A', fontSize: '14px' }}>
          {q.regSub}
        </p>
      </div>
      ...
      <form
        ...
        style={{
          background: '#FFFFFF',
          border: '1px solid rgba(6,3,141,0.10)',
        }}
      >
        <Field
          label={q.nameLabel}
        ...
        >
          <input
            type="tel"
            value={form.mobile}
            placeholder={q.mobilePlaceholder}
        ...
        >
          <select
            ...
            style={{
              ...
              appearance: 'none',
              cursor: 'pointer',
              color: form.state ? '#0A0840' : '#8886C0',
            }}
            onChange={(e) =>
        ...
        <button
          type="submit"
          className="btn-primary text-base py-4 mt-2 w-full"
        >
          {q.continueBtn}
        </button>
      </form>
    ...
    >
      <div className="text-center mb-10">
        ...
        >
          ...
          <span
            style={{
              background: 'linear-gradient(135deg,#ef4444,#06038D)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
              backgroundClip: 'text',
            }}
      ...
      <div
        className="rounded-3xl p-7 sm:p-9 flex flex-col gap-4 mb-6 shadow-blue"
        style={{
          background: '#FFFFFF',
          border: '1px solid rgba(6,3,141,0.10)',
        }}
      >
        ...
        <div
          ...
          style={{
            background: 'rgba(25,170,237,0.06)',
            border: '1px solid rgba(25,170,237,0.18)',
          }}
        >
          <p
            style={{
...
function QuizScreen({
  ...
  // Per-question countdown: resets every time the question changes
    ...
    >
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="rounded-3xl p-7 sm:p-9 mb-6 shadow-blue"
          style={{
            background: '#FFFFFF',
            border: '1px solid rgba(6,3,141,0.10)',
          }}
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      style={{
                        ...
                        border: sel
                          ? '1px solid #06038D'
                          : '1px solid rgba(6,3,141,0.15)',
                      }}
                    >
                      {['A', 'B', 'C', 'D'][idx]}
                    </div>

                    <span style={{ color: '#0A0840' }}>
                      {opt}
                    </span>
                  </div>
                </motion.button>
      ...
      <div className="flex items-center justify-between">
        ...
        <motion.button
          whileHover={{ scale: hasSelected ? 1.03 : 1 }}
          whileTap={{ scale: hasSelected ? 0.97 : 1 }}
          ...
          style={{
            ...
            background: hasSelected
              ? 'linear-gradient(135deg,#06038D,#0805b0)'
              : 'rgba(6,3,141,0.06)',
            color: hasSelected ? 'white' : '#8886C0',
            cursor: hasSelected ? 'pointer' : 'not-allowed',
            border: hasSelected
              ? 'none'
              : '1px solid rgba(6,3,141,0.12)',
            boxShadow: hasSelected
              ? '0 4px 16px rgba(6,3,141,0.25)'
              : 'none',
          }}
        >
...
function ResultScreen({ result, onRetry }) {
  ...
  const level =
    pct >= 90
      ? { label: q.level1, emoji: '🏆', color: '#06038D' }
      : pct >= 70
      ? { label: q.level2, emoji: '✊', color: '#19AAED' }
      : pct >= 50
      ? { label: q.level3, emoji: '📖', color: '#138808' }
  ...
  useEffect(() => {
    ...
    generateCertificate(userInfo.name)
      .then((url) => {
        ...
        else setCertError('Template not found');
      })
      .catch(() =>
        setCertError('Could not generate certificate')
      )
  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: 'My Hum Mein Hai Rajiv Score',
        text,
      });
    } else {
  ...
  return (
    ...
    >
      {/* Score card */}
      <div
        className="rounded-3xl p-8 sm:p-10 mb-6 text-center relative overflow-hidden shadow-blue"
        style={{
          background: '#FFFFFF',
      ...
      >
        <div
          ...
          style={{
            background:
              'linear-gradient(90deg,#FF9933 33%,white 33%,white 66%,#138808 66%)',
          }}
        />
        ...
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at 50% 0%,${level.color}05,transparent 60%)`,
          }}
        />
        ...
        <h2
          className="section-title text-5xl mb-2 relative z-10"
          style={{ color: '#0A0840' }}
        >
          {score}
          <span style={{ color: '#8886C0' }}>/{total}</span>
        </h2>

        <p
          className="font-bold text-base mb-6 relative z-10"
        ...
        {timedOut && (
          <div
            className="mt-3 flex items-center gap-2 justify-center relative z-10"
            style={{
              color: '#ef4444',
              fontSize: '12px',
            }}
          >
            <Clock size={12} /> {q.timedOut}
          </div>
        )}

        {submitStatus === 'saving' && (
          <p
            className="mt-3 text-xs relative z-10"
            style={{ color: '#8886C0' }}
          >
            {q.scoreSaving}
          </p>
      ...
      {/* Certificate section */}
      <div
        className="rounded-3xl p-6 mb-6 shadow-blue"
        style={{
          background: '#FFFFFF',
          border: '1px solid rgba(6,3,141,0.10)',
        }}
      >
        <div className="flex items-center justify-between gap-4 flex-wrap">
          ...
          <motion.button
            ...
            onClick={() =>
              downloadCertificate(certUrl, userInfo.name)
            }
      ...
      {/* Answer review */}
      <div
        className="rounded-3xl p-6 sm:p-8 mb-6 shadow-blue"
        style={{
          background: '#FFFFFF',
          border: '1px solid rgba(6,3,141,0.10)',
        }}
      >
        ...
        >
          <CheckCircle2 size={18} style={{ color: '#138808' }} />{' '}
          {q.answerReview}
        </h3>
        ...
        >
          {sessionQuestions.map((ques) => {
            const ua = answers[ques.id];
            const ok = ua === ques.correct;
            const att = ua !== undefined;
              ...
              >
                ...
                <div>
                  ...
                  {!ok && (
                    ...
                    >
                      {q.correct} {ques.options[ques.correct]}
                    </p>
                  )}
                </div>
              </div>
...
export default function QuizPage() {
  ...
  const handleQuizComplete = async (res) => {
    ...
    setResult({
      ...res,
      sessionQuestions: formattedQuestions,
      submitStatus: 'saving',
    });
      ...
      >
        ...
        <div
          ...
          style={{
            height: '300px',
            background:
              'radial-gradient(ellipse at 50% 0%,rgba(25,170,237,0.10) 0%,transparent 70%)',
          }}
        />

        <div className="relative z-10 px-4 sm:px-6 pb-20 pt-28">
          <AnimatePresence mode="wait">
            {stage === STAGES.FORM && (
              <motion.div key="form">
                <RegistrationForm
            ...
            {stage === STAGES.RULES && (
              <motion.div key="rules">
                <RulesScreen onStart={handleStartQuiz} />
              </motion.div>
            )}
